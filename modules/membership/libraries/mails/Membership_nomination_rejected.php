...
/**
 * Sent to the nominee when their nomination is rejected by admin.
 *
 * Usage:
 *   send_mail_template('Membership_nomination_rejected', 'membership',
 *       $nominee_email, $nominee_contact_id, $election_title);
 */
class Membership_nomination_rejected extends App_mail_template
{
    protected $for = 'customer';

    public $slug = 'membership-nomination-rejected';
