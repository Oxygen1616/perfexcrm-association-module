...
<!-- Miles Stones -->
<div class="modal fade" id="milestone_modal" data-backdrop="static"  tabindex="-1" role="dialog">
    <div class="modal-dialog">
        <?php echo form_open(admin_url('project_templates/milestone'), ['id' => 'project_template_milestone_form']); ?>
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <?php echo render_input('start_date', 'pt_milestone_start_date'); ?>
                        <?php echo render_input('due_date', 'pt_milestone_due_date'); ?>
                        ...
                        <?php } ?>
                        <?php echo render_input('milestone_order', 'project_milestone_order', total_rows(PROJECT_TEMPLATES_MILESTONE_TABLE_NAME, ['project_template_id' => $project->id]) + 1, 'number'); ?>
                    </div>
                </div>
            </div>
