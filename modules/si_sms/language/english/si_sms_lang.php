...
$lang['si_sms_label_proposal_created'] = 'New Proposal Created or Sent (to customer)'.$lang['si_sms_tag'];
$lang['si_sms_info_proposal_created'] = 'Trigger when New Proposal is Created or Sent for Client, SMS will be sent phone number mentioned in Proposal';
$lang['si_sms_label_estimate_created'] = 'New Estimate Created or Sent (to customer)'.$lang['si_sms_tag'];
$lang['si_sms_info_estimate_created'] = 'Trigger when New Estimate is Created or Sent for Client, SMS will be sent customer Primary contact (or to Client).';
...
$lang['si_sms_label_estimate_request_form_submitted_to_staff'] = 'Estimate Request Form Submitted (to staff)'.$lang['si_sms_tag'];
$lang['si_sms_info_estimate_request_form_submitted_to_staff'] = 'Trigger when Estimate Request Form is submitted by Estimate request link, SMS will be sent to estimate request form assigned staff.';
$lang['si_sms_label_estimate_request_status_changed_to_staff'] = 'Estimate Request Status Changed (to staff)'.$lang['si_sms_tag'];
$lang['si_sms_info_estimate_request_status_changed_to_staff'] = 'Trigger when Estimate Request status is changed, SMS will be sent to staff members assigned to Estimate Request.';
